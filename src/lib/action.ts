import {
  ...
  export async function OnBoardingPrivateData(data: PostIFormData, accessToken: string) {
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/members/basic-inform`, {
      method: 'POST',
      headers: {
  ...
  export async function GetOnBoardingData(accessToken: string) {
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/private/onBoarding`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostProfileTeamBuildingField(accessToken: string, selectedShortTermFields: string[]) {
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/private/team_building_field`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json;charset=UTF-8',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostProfileRegion(access_token: string, selectedArea: string, selectedSubArea: string) {
    return await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/private/region`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
  ...
  export async function PostRoleData(accessToken: string, jobRoleNames: string[], skillNames: string[]) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/private/job/skill`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostSchoolData(accessToken: string, educationList: Education) {
    const response = fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/private/education`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostOneSchoolData(accessToken: string, education: OneSchoolFormInputs) {
    // education 단일 객체로 받기
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/private/education`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PutSchoolData(accessToken: string, education: OneSchoolFormInputs, educationId: number) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/private/education/${educationId}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostAntecedentData(accessToken: string, careerList: Career[]) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/private/antecedents`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostOneAntecedentData(accessToken: string, antecedent: AntecedentFormInputs) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/private/antecedent`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function DeleteAntecedentData(accessToken: string, antecedentsId: number) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/private/antecedents/${antecedentsId}`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostProfileData(accessToken: string, payload: any, profileImage: File | null) {
    ...
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/private/mini-profile`, {
      method: 'POST',
      headers: {
        Authorization: `Bearer ${accessToken}`,
      },
  ...
  export async function PutProfileData(accessToken: string, payload: any, profileImage: File | null) {
    ...
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/private/mini-profile/update`, {
      method: 'POST',
      headers: {
        Authorization: `Bearer ${accessToken}`,
      },
  ...
  export const TeamOnBoardingData = async (accessToken: string) => {
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/team/onBoarding`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export const TeamOnBoardingField = async (accessToken: string, data: TeamOnBoadingFieldFormInputs) => {
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/team/team_building_field/basic_inform`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export const UpdateTeamOnBoardingField = async (accessToken: string, data: updateTeamOnBoadingFieldFormInputs) => {
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/update/onBoarding/team/mini-profile`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export const TeamOnBoardingActivityWay = async (accessToken: string, data: TeamOnBoardingActivityWayFormInputs) => {
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/team/activity`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostTeamProfile(
    ...
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/team/mini-profile`, {
      method: 'POST',
      headers: {
        Authorization: `Bearer ${accessToken}`,
      },
  ...
  export async function GetMyResume(accessToken: string) {
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/private/profile`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostProfileIntroduction(accessToken: string, introduction: string) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/private/introduction`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostProfileAward(accessToken: string, data: AwardFormInputs) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/private/award`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PutProfileAward(accessToken: string, data: AwardFormInputs, awardsId: number) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/private/award/${awardsId}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function DeleteProfileAward(accessToken: string, awardsId: number) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/private/awards/${awardsId}`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostProfileAttchURL(accessToken: string, data: URLFormInputs[]) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/private/attach/url`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function GetTeamResume(accessToken: string) {
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/team/profile`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostTeamBuildingField(accessToken: string, selectedShortTermFields: string[]) {
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/team/team_building_field`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json;charset=UTF-8',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostTeamIntroduction(accessToken: string, teamIntroduction: string) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/team/introduction`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostTeamMember(accessToken: string, data: TeamMemberData[]) {
    return await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/team/members`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PutTeamMember(accessToken: string, data: TeamMemberData, teamMemberIntroductionId: number) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/team/member/${teamMemberIntroductionId}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function DeleteTeamMember(accessToken: string, teamMemberIntroductionId: number) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/team/members/${teamMemberIntroductionId}`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostTeamMemberAnnouncement(accessToken: string, data: TeamAnnouncementMemberInterface) {
    return await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/team/member/announcement`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function DeleteTeamMemberAnnouncement(accessToken: string, teamMemberAnnouncementId: number) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/team/members/announcements/${teamMemberAnnouncementId}`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PutTeamMemberAnnouncement(
    ...
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/team/member/announcement/${teamMemberAnnouncementId}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostTeamHistory(accessToken: string, data: TeamHistoryDataSet) {
    return await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/team/history`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PutTeamHistory(accessToken: string, data: TeamHistoryDataSet, teamHistoryId: number) {
    return await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/team/history/${teamHistoryId}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function DeleteTeamHistory(accessToken: string, teamHistoryId: number) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/team/history/${teamHistoryId}`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostTeamAttchURL(accessToken: string, data: TeamURLFormInputs[]) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/team/attach/url`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function GetTeamMembers() {
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/search/private/profile`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  export async function GetTeams() {
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/search/team/profile`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  export async function GetPrivateData(accessToken: string, miniProfileId: number) {
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/browse/private/profile/${miniProfileId}`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function GetTeamData(accessToken: string, teamMiniProfileId: number) {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/browse/team/profile/${teamMiniProfileId}`,
      {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
  ...
  export async function GetMatchReceived(accessToken: string) {
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/matching/received`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function GetMatchSent(accessToken: string) {
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/matching/request`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function GetMatchAccomplished(accessToken: string) {
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/matching/success`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function GetResumeExist(accessToken: string) {
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/existence/profile`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostMatchRequest(accessToken: string, requestMessage: string, profileId: number) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/private/profile/matching/private/${profileId}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostTeamMatchRequest(accessToken: string, requestMessage: string, profileId: number) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/team/profile/matching/private/${profileId}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostTeamProfileMatchRequest(accessToken: string, requestMessage: string, teamProfileId: number) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/private/profile/matching/team/${teamProfileId}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostMatchResponse(accessToken: string, privateMatchingId: number, isAllowMatching: boolean) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/allow/private/matching/${privateMatchingId}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostTeamMatchResponse(accessToken: string, teamMatchingId: number, isAllowMatching: boolean) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/allow/team/matching/${teamMatchingId}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostMatchContact(accessToken: string, privateMatchingId: number) {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/success/private/matching/contact/${privateMatchingId}`,
      {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
  ...
  export async function PostTeamMatchContact(accessToken: string, teamMatchingId: number) {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/success/team/matching/contact/${teamMatchingId}`,
      {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
  ...
  export async function PostSaveMember(accessToken: string, miniProfileId: number) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/wish/private/profile/${miniProfileId}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function PostSaveTeam(accessToken: string, teamMemberAnnouncementId: number) {
    return fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/wish/team/profile/${teamMemberAnnouncementId}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function GetSavedMembers(accessToken: string) {
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/wish/private/profile/list`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
  ...
  export async function GetSavedTeams(accessToken: string) {
    const response = await fetch(`${process.env.NEXT_PUBLIC_AURORA_SERVER_URL}/wish/team/profile/list`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${accessToken}`,
