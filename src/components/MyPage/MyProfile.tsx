...
export default function MyProfile({ profileData }: MyProfileProps) {
    ...
    return (
        <>
                ...
                <div className="flex items-center gap-[0.875rem] self-stretch">
                    ...
                    <div className="flex h-[2.8125rem] pl-[21.0625rem] justify-end items-center flex-[1_0_0]">
                        <button 
                            ...
                            className="flex h-[2.8125rem] p-[0.1875rem] px-[0.6875rem] justify-center items-center gap-[0.625rem] rounded-[0.25rem] bg-[#F0F0F0]"
                        >
            ...
            <ProfileEdit isOpen={isProfileEditModalOpen} onClose={() => setIsProfileEditModalOpen(false)} />
        </>
    )
}
