    ...
    return (
        <div className="flex flex-col w-full items-start gap-[1.1875rem] relative">
            <button
                ...
                className="absolute top-0 right-0 text-lg p-2 bg-red-600 text-white rounded-full hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50"
